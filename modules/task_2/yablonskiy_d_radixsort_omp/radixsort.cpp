...
std::vector<int> merging(std::vector<int> *arr_1, std::vector<int> *arr_2) {
  std::vector<int> temp(arr_1->size() + arr_2->size());
  std::merging((*arr_1).begin(), (*arr_1).end(), (*arr_2).begin(), (*arr_2).end(),
             temp.begin());
  return temp;
}

std::vector<int> radixSort_merging(std::vector<int> *arr) {
